...
4. **The easiest method**: using Cheat Engine with the provided cheat tables for [Nations](https://github.com/brokenphilip/TMFWSI/blob/main/ManialinkNations.CT) [United](https://github.com/brokenphilip/TMFWSI/blob/main/ManialinkUnited.CT).
